...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2020 at 10:58 AM
...
CREATE TABLE `country` (
  ...
  `IndependantYear` int(4) DEFAULT NULL,
  `Population` int(10) NOT NULL DEFAULT 0,
  ...
  `CountryCode2` char(2) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `country` (`CountryCode`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndependantYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `CountryCode2`) VALUES
...
--
ALTER TABLE `countrylanguage`
  ADD CONSTRAINT `countryLanguage_ibfk_1` FOREIGN KEY (`CountryCode`) REFERENCES `country` (`CountryCode`);
COMMIT;
